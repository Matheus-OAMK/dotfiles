# Generated by Powerlevel10k configuration wizard on 2024-07-16 at 13:54 EEST.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%084F'   # green foreground 84
      local   modified='%184F'  # yellow foreground
      local  untracked='%105F'   # blue foreground
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=84
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=218
